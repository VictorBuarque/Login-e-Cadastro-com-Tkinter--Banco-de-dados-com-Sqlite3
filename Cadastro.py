...
from tkinter.tix import TEXT, INTEGER
def abrir_janela ():
    def salvar ():
    #Validação
    ...
    variable=terms_reg_status_var, onvalue="Concordo", offvalue="Nao concordo")
    ...
    cancel_button = tkinter.Button(frame, text="Cancelar", command=window1.quit)
